...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SeriesTweet.twitter_status_id'
        db.alter_column('series_seriestweet', 'twitter_status_id', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'SeriesTweet.twitter_status_id'
        db.alter_column('series_seriestweet', 'twitter_status_id', self.gf('django.db.models.fields.CharField')(max_length=17))
    ...
    models = {
        ...
        'series.series': {
            ...
            'genre': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'genres'", 'symmetrical': 'False', 'to': "orm['series.Genre']"}),
        ...
        'series.seriestweet': {
            ...
            'twitter_status_id': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'})
        },
        'series.venue': {
