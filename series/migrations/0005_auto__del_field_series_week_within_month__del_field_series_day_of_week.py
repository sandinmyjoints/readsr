...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Series.week_within_month'
        db.delete_column('series_series', 'week_within_month_id')

        # Deleting field 'Series.day_of_week'
        db.delete_column('series_series', 'day_of_week_id')

        # Deleting field 'Series.notes'
        db.delete_column('series_series', 'notes')

        # Deleting field 'Series.time'
        db.delete_column('series_series', 'time')

        # Deleting field 'Series.id'
        db.delete_column('series_series', 'id')

        # Adding field 'Series.event_ptr'
        db.add_column('series_series', 'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['swingtime.Event'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Series.week_within_month'
        db.add_column('series_series', 'week_within_month', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['series.WeekWithinMonth'], null=True, blank=True), keep_default=False)

        # Adding field 'Series.day_of_week'
        db.add_column('series_series', 'day_of_week', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['series.DayOfWeek'], null=True, blank=True), keep_default=False)

        # Adding field 'Series.notes'
        db.add_column('series_series', 'notes', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'Series.time'
        db.add_column('series_series', 'time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(18, 0)), keep_default=False)

        # Adding field 'Series.id'
        db.add_column('series_series', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)

        # Deleting field 'Series.event_ptr'
        db.delete_column('series_series', 'event_ptr_id')
    ...
    models = {
        ...
        'series.series': {
            'Meta': {'ordering': "('primary_name',)", 'object_name': 'Series', '_ormbases': ['swingtime.Event']},
