...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Series.secondary_name'
        db.delete_column('series_series', 'secondary_name')

        # Deleting field 'Series.primary_name'
        db.delete_column('series_series', 'primary_name')


    def backwards(self, orm):
        
        # Adding field 'Series.secondary_name'
        db.add_column('series_series', 'secondary_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Series.primary_name'
        db.add_column('series_series', 'primary_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200, unique=True), keep_default=False)
