...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Series.last_update'
        db.delete_column('series_series', 'last_update')

        # Deleting field 'Series.created'
        db.delete_column('series_series', 'created')


    def backwards(self, orm):
        
        # Adding field 'Series.last_update'
        db.add_column('series_series', 'last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Series.created'
        db.add_column('series_series', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
