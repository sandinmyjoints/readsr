...
urlpatterns = patterns('',
	...
	url(r'^list_readings/(?P<num_months>\d+)/$', views.list_readings_month, name="list-readings-by-months"),
	url(r'^list_readings/(?P<num_months>\d+)/(?P<ajax>\d)/(?P<index>\d)/$', views.list_readings_month, name="list-readings-by-months-ajax"),
